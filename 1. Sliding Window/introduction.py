# coding: utf-8
# When to use: In many problems dealing with an array (or a LinkedList), we are asked to find or calculate something among all the contiguous subarrays (or sublists) of a given size.
...
def optimal_sliding_window(array, k):
    ...
    # windowSum is a floating value and will be used to keep a track of the sum and windowStart is to keep track of the index when it slides over
    windowSum, windowStart = 0.0, 0
    result = []  # this result array is going to contain the averages of the window
    # windowEnd is the index which will shift over once the window hits K
